...
Public Class rptDesgloseIeps
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FacturacionPersonal.rptDesgloseIeps.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDesgloseIeps
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDesgloseIeps = New rptDesgloseIeps()
        rpt.Site = Me.Site
        Return rpt
    End Function
