...
Public Class rptFEBajamar33CANC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FacturacionPersonal.rptFEBajamar33CANC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFEBajamar33CANC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFEBajamar33CANC = New rptFEBajamar33CANC()
        rpt.Site = Me.Site
        Return rpt
    End Function
