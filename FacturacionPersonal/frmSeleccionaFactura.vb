Public Class frmSeleccionaFactura
    ...
    Private Sub frmSeleccionaFactura_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGADATOS()
        ...
        End If
        Dim QUERY As String
        QUERY = "SELECT F.RFCEMISOR,F.SERIE,F.FOLIO,F.RFCCLIENTE,F.FECHA,F.TOTAL,MARCAR=CONVERT(BIT,0) FROM FACTURAS F WHERE RFCEMISOR='" + EMI + "' AND RFCCLIENTE='" + CLI + "' AND ESTADO=2 AND FECHA>=DBO.INICIODELAÑO(GETDATE())"
        ...
        If DGV.Rows.Count <= 0 Then
            MessageBox.Show("El cliente no cuenta con facturas realizadas en el periodo anual actual", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Error)
