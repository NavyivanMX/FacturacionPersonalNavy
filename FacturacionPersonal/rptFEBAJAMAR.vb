...
Public Class rptFEBAJAMAR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FacturacionPersonal.rptFEBAJAMAR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFEBAJAMAR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFEBAJAMAR = New rptFEBAJAMAR()
        rpt.Site = Me.Site
        Return rpt
    End Function
