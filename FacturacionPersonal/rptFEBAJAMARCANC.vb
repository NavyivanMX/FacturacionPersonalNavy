...
Public Class rptFEBAJAMARCANC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FacturacionPersonal.rptFEBAJAMARCANC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFEBAJAMARCANC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFEBAJAMARCANC = New rptFEBAJAMARCANC()
        rpt.Site = Me.Site
        Return rpt
    End Function
