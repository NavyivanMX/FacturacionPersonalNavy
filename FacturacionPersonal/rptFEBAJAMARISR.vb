...
Public Class rptFEBAJAMARISR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FacturacionPersonal.rptFEBAJAMARISR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFEBAJAMARISR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFEBAJAMARISR = New rptFEBAJAMARISR()
        rpt.Site = Me.Site
        Return rpt
    End Function
