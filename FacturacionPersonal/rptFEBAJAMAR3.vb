...
Public Class rptFEBAJAMAR3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FacturacionPersonal.rptFEBAJAMAR3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFEBAJAMAR3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFEBAJAMAR3 = New rptFEBAJAMAR3()
        rpt.Site = Me.Site
        Return rpt
    End Function
