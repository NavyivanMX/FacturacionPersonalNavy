Public Class frmPrincipal
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        CORPORATIVO = 4
        VCFD = "4.0"
        COLORFUENTE = System.Drawing.Color.Black
        VERSION = "BETA1.0"
        NombreComun = "Navysoluciones"
        'RFCBASE = "FRG101213EQ6"
        'IP = "201.120.5.21"
        IP = "127.0.0.1"
        'IP = "soluserver.ddns.net"
        'IP = "bahamut.grupobajamar.com"

        'Dim VAF As New frmAutoFacturacion
        'VAF.ShowDialog()
        'IP = "structureserver2.ddns.net"
        ...
        CadenaConexion = "Data Source=" + IP + ",1433;Network Library=DBMSSOCN;Initial Catalog=FENAVYSOLUCIONES;User ID=dbaadmin;Password=masterkey"
        'CadenaConexion = "Data Source=" + IP + ",1433;Network Library=DBMSSOCN;Initial Catalog=FEBAJAMAR;User ID=dbaadmin;Password=masterkey"
        'CadenaConexion = "Data Source=" + IP + ",1433;Network Library=DBMSSOCN;Initial Catalog=FEINTMEX;User ID=MarosIlocal;Password=Loco*1234"
        'CadenaConexion = "Data Source=LOCALHOST;Initial Catalog=FACTURACIONELECTRONICA;User ID=Kenbunym*14;Password=aGi1sgXN*14"
    ...
    Public Function CONECTAR(ByVal PAGINA As String)
        ...
        End Try
        CadenaConexion = "Data Source=187.216.125.210,1433;Network Library=DBMSSOCN;Initial Catalog=FEBAJAMAR;User ID=dbaadmin;Password=masterkey"
        CONX.ConnectionString = CadenaConexion
        Try
            CONX.Open()
            IP = "187.216.125.210"
            MessageBox.Show("Conectado desde 210", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Asterisk)
            Return True
        Catch ex As Exception
            MessageBox.Show("Intento de Conexión 2 Fallido (Alterno A)", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Asterisk)
        End Try
        CadenaConexion = "Data Source=187.216.125.211,1433;Network Library=DBMSSOCN;Initial Catalog=FEBAJAMAR;User ID=dbaadmin;Password=masterkey"
        CONX.ConnectionString = CadenaConexion
        Try
            CONX.Open()
            IP = "187.216.125.211"
            MessageBox.Show("Conectado desde 211", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Asterisk)
            Return True
        Catch ex As Exception
    ...
    Private Sub INICIAR()
        If VERIFICAVERSION() Then
            ...
            End If
        Else
            frmLigaVersion.MOSTRAR(LIGA, "C:\NUEVAVERSION\FacturacionElectronica.RAR", "Actualización de Facturacion Electronica")
            Me.Close()
        End If
    End Sub
    ...
    Private Function VERIFICAVERSION() As Boolean
        ...
        Try
            ...
            Dim VER As String
            'Dim SQL As New SqlClient.SqlCommand("SELECT VERSION,LIGA FROM VERSIONES WHERE SISTEMA='NAVY'", Me.CONX)
    ...
    Private Sub CompraDeTimbresToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CompraDeTimbresToolStripMenuItem.Click
        Dim VCT As New frmComprasTimbres
        VCT.ShowDialog()
    End Sub

    Private Sub XMLPDFExcelToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles XMLPDFExcelToolStripMenuItem.Click
        Dim VEXP As New frmExcel2PDFXML
        VEXP.ShowDialog()
    End Sub

    Private Sub DesgloseDeFacturasToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DesgloseDeFacturasToolStripMenuItem.Click
        Dim VDF As New frmDesgloseFacturacion
        VDF.ShowDialog()
    End Sub

    Private Sub CorteMensualToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CorteMensualToolStripMenuItem.Click
        Dim VAF As New frmAutoFacturacion
        VAF.ShowDialog()
    End Sub
End Class
