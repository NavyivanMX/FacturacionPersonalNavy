...
Public Class rptNotaDeVenta2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FacturacionPersonal.rptNotaDeVenta2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNotaDeVenta2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNotaDeVenta2 = New rptNotaDeVenta2()
        rpt.Site = Me.Site
        Return rpt
    End Function
