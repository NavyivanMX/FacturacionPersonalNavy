...
Public Class frmClientes
    ...
    Private Sub CARGADATOS()
        DGV.DataSource = BDLlenatabla("SELECT * FROM DOMICILIOSCLIENTES WHERE RFC='" + TXTRFC.Text + "'", frmPrincipal.CadenaConexion)
    ...
    Private Sub BTNBUSCAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNBUSCAR.Click
        frmClsBusqueda.BUSCAR("SELECT RFC,NOMBRE,NOMBRECOMERCIAL [NOMBRE COMERCIAL] FROM CLIENTES ", " WHERE NOMBRECOMERCIAL", " ORDER BY NOMBRE", "Búsqueda de Clientes", "Nombre del Cliente", "Cliente(s)", 1, frmPrincipal.CadenaConexion, True)
